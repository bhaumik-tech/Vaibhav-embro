...
class ProductionController extends Controller implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('page.permission:production,view', only: ['index', 'show', 'print']),
            new Middleware('page.permission:production,edit', only: ['create', 'store', 'edit', 'update']),
            new Middleware('page.permission:production,remove', only: ['destroy']),
        ];
    }
