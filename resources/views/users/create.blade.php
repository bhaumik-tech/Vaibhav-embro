                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-4 border border-slate-300 p-4 bg-white">
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" name="permissions[]" value="admin" class="w-4 h-4 text-green-600 border-slate-300 rounded focus:ring-green-500">
                            <span class="text-sm font-bold text-slate-700">Full Admin (All Firms)</span>
                        </label>
                        @foreach($firms as $firm)
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input type="checkbox" name="permissions[]" value="{{ $firm->id }}" class="w-4 h-4 text-green-600 border-slate-300 rounded focus:ring-green-500">
