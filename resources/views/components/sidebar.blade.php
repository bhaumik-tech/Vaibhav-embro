...
<div class="flex-1 overflow-y-auto sidebar-content bg-white py-4">
    @php
        $menuGroups = [
            ...
            'PAYMENTS' => [
                ['name' => 'Generate Cheque', 'url' => '/generate-cheques', 'icon' => 'M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2z', 'permission_key' => 'generate_cheque'],
