        ...
        <div class="p-3 border-t border-slate-200 bg-white flex flex-wrap justify-end gap-4">
            <div class="flex items-center gap-3 border border-slate-200 px-3 py-1.5 rounded bg-slate-50">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <input type="number" step="0.01" name="vatav_percent" value="5.00" class="w-16 border border-slate-300 p-1 text-right font-bold text-slate-900 bg-white shadow-sm focus:ring-indigo-500 rounded text-sm">
                </div>
            </div>
            <div class="flex items-center gap-3 border border-slate-200 px-3 py-1.5 rounded bg-slate-50">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <input type="number" step="0.01" name="sgst_percent" value="2.50" class="w-16 border border-slate-300 p-1 text-right font-bold text-slate-900 bg-white shadow-sm focus:ring-indigo-500 rounded text-sm">
                </div>
            </div>
            <div class="flex items-center gap-3 border border-slate-200 px-3 py-1.5 rounded bg-slate-50">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <input type="number" step="0.01" name="cgst_percent" value="2.50" class="w-16 border border-slate-300 p-1 text-right font-bold text-slate-900 bg-white shadow-sm focus:ring-indigo-500 rounded text-sm">
                </div>
            </div>
            <div class="flex items-center gap-3 border border-slate-200 px-3 py-1.5 rounded bg-slate-50">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <input type="number" step="0.01" name="tds_percent" value="1.00" class="w-16 border border-slate-300 p-1 text-right font-bold text-slate-900 bg-white shadow-sm focus:ring-indigo-500 rounded text-sm">
                </div>
            </div>
