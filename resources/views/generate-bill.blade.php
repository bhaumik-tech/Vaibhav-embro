        ...
        <div class="flex flex-col lg:flex-row gap-4">
            ...
            <div class="w-full lg:w-1/3 bg-white border border-slate-200 p-4 shadow-sm flex flex-col justify-center gap-2">
                <div class="flex items-center gap-1">
                    ...
                    <input type="text" name="bill_no" placeholder="Auto" class="bg-transparent border-none p-0 text-slate-900 font-bold text-lg focus:ring-0 w-full placeholder-slate-400">
                </div>
                <div class="flex items-center gap-1">
                    <span class="font-semibold text-slate-700 text-lg whitespace-nowrap">Date.-</span>
                    <input type="date" name="date" value="{{ date('Y-m-d') }}" required class="bg-transparent border-none p-0 text-slate-900 font-bold text-lg focus:ring-0 w-full">
                </div>
            </div>
        </div>
    </div>
