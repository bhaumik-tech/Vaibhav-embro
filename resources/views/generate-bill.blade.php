        ...
        <div class="p-2 border-t border-slate-200 bg-white flex flex-wrap justify-end gap-3">
            <div class="flex items-center gap-1 border border-slate-200 p-1 rounded bg-slate-50">
                ...
                <div class="flex items-center gap-1">
                    ...
                    <input type="number" step="0.01" name="vatav_percent" value="5.00" class="w-14 border border-slate-200 p-0.5 text-right font-bold text-slate-900 bg-white shadow-sm focus:ring-indigo-500 rounded text-xs">
                </div>
            </div>
            <div class="flex items-center gap-1 border border-slate-200 p-1 rounded bg-slate-50">
                ...
                <div class="flex items-center gap-1">
                    ...
                    <input type="number" step="0.01" name="sgst_percent" value="2.50" class="w-14 border border-slate-200 p-0.5 text-right font-bold text-slate-900 bg-white shadow-sm focus:ring-indigo-500 rounded text-xs">
                </div>
            </div>
            <div class="flex items-center gap-1 border border-slate-200 p-1 rounded bg-slate-50">
                ...
                <div class="flex items-center gap-1">
                    ...
                    <input type="number" step="0.01" name="cgst_percent" value="2.50" class="w-14 border border-slate-200 p-0.5 text-right font-bold text-slate-900 bg-white shadow-sm focus:ring-indigo-500 rounded text-xs">
                </div>
            </div>
            <div class="flex items-center gap-1 border border-slate-200 p-1 rounded bg-slate-50">
                ...
                <div class="flex items-center gap-1">
                    ...
                    <input type="number" step="0.01" name="tds_percent" value="1.00" class="w-14 border border-slate-200 p-0.5 text-right font-bold text-slate-900 bg-white shadow-sm focus:ring-indigo-500 rounded text-xs">
                </div>
            </div>
