                ...
                <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mt-2">
                    <div class="col-span-2 flex items-center gap-2">
                        ...
                        @if(isset($interExchange) && $interExchange->photo_path)
                            <a href="{{ Storage::disk('public')->url($interExchange->photo_path) }}" target="_blank" class="text-indigo-600 hover:text-indigo-800 text-sm font-bold flex items-center gap-1" title="View Current Photo">
