                    ...
                    @forelse($interExchanges as $entry)
                        <tr class="border-b border-slate-200 hover:bg-slate-50 transition-colors">
                            ...
                            <td class="p-4 text-center border-r border-slate-200">
                                @if($entry->photo_path)
                                    <a href="{{ Storage::disk('public')->url($entry->photo_path) }}" target="_blank" class="inline-flex text-indigo-600 hover:text-indigo-800 transition-colors" title="View Photo">
                            ...
                            <td class="p-4 flex items-center justify-center gap-3">
                                @canpage('inter_exchange', 'view')
                                <a href="{{ route('inter-exchange.show', $entry) }}" class="text-teal-600 hover:text-teal-800 transition-colors" title="View Details">
