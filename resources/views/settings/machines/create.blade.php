...
<div class="h-full flex flex-col bg-slate-50">
    ...
    <div class="flex-1 overflow-y-auto px-6 pb-6">
        <div class="max-w-3xl bg-white border border-slate-300 shadow-sm mx-auto">
            <div class="p-6">
                <form action="{{ route('machines.store') }}" method="POST" class="flex flex-col gap-5">
                    @csrf
                    ...
                    <div class="flex gap-4">
                        <div class="w-1/3">
                            ...
                            <input type="text" name="machine_no" placeholder="Enter No." class="w-full border border-slate-300 p-2 text-sm font-bold text-slate-700 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500" required>
                        </div>
                        <div class="flex-1">
                            <label class="block text-[11px] font-bold text-slate-500 uppercase tracking-wider mb-1.5">Place</label>
                            <input type="text" name="place" placeholder="Location/Place" class="w-full border border-slate-300 p-2 text-sm font-bold text-slate-700 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4">
                        <div class="flex-1">
                            ...
                            <input type="number" name="no_of_head" placeholder="0" class="w-full border border-slate-300 p-2 text-sm font-bold text-slate-700 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 text-center">
                        </div>
                        <div class="flex-1">
                            <label class="block text-[11px] font-bold text-slate-500 uppercase tracking-wider mb-1.5">Area</label>
                            <input type="text" name="area" placeholder="Area" class="w-full border border-slate-300 p-2 text-sm font-bold text-slate-700 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 text-center">
                        </div>
                        <div class="flex-1">
                    ...
                    <div class="flex flex-col md:flex-row gap-6">
                        ...
                        <div class="flex items-center gap-3 bg-slate-50 border border-slate-200 p-3 flex-1">
                            <input type="checkbox" name="bonus_production_enabled" value="1" class="w-5 h-5 text-indigo-600 border-slate-300 focus:ring-indigo-500 rounded-sm cursor-pointer">
                        ...
                        <!-- Bonus on % (Frame) -->
                        <div class="flex items-center gap-3 bg-slate-50 border border-slate-200 p-3 flex-1">
                            <input type="checkbox" name="bonus_frame_enabled" value="1" class="w-5 h-5 text-indigo-600 border-slate-300 focus:ring-indigo-500 rounded-sm cursor-pointer">
                            <div class="text-sm font-bold text-slate-700 uppercase tracking-wide flex-1">
                                Bonus on % (Frame)
                            </div>
                            <div class="flex items-center">
