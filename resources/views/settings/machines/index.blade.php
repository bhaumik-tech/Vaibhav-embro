...
<div class="h-full flex flex-col">
    ...
    <div class="flex items-center gap-4 mb-6 shrink-0">
        ...
        <a href="{{ route('machines.create') }}" class="h-10 px-6 bg-indigo-600 text-white font-bold text-sm uppercase tracking-wider flex items-center justify-center hover:bg-indigo-700 transition-colors shadow-sm border border-indigo-700">
            + Add New Machine
        </a>
    </div>
