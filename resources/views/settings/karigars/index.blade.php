            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-slate-100 border-b border-slate-300">
                        ...
                        <th class="p-4 text-xs font-bold text-slate-700 uppercase tracking-widest border-r border-slate-300">Machines</th>
                ...
                <tbody>
                    @forelse($karigars as $karigar)
                        <tr class="border-b border-slate-200 hover:bg-slate-50 transition-colors">
                            ...
                            <td class="p-4 text-sm font-medium text-slate-600 border-r border-slate-200">
                                @php
                                    $machines = [];
                                    if($karigar->machine1) $machines[] = $karigar->machine1->machine_no;
                                    if($karigar->machine2) $machines[] = $karigar->machine2->machine_no;
                                    if($karigar->machine3) $machines[] = $karigar->machine3->machine_no;
                                @endphp
                                {{ count($machines) > 0 ? implode(', ', $machines) : '-' }}
                            </td>
