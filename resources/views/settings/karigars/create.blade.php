...
<div class="h-full flex flex-col bg-slate-50">
    ...
    <div class="flex-1 overflow-y-auto px-6 pb-6">
        <div class="max-w-4xl bg-white border border-slate-300 shadow-sm mx-auto">
            <div class="p-6">
                <form action="{{ route('karigars.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-5">
                    @csrf
                    
                    <div class="flex gap-4">
                        <div class="flex-1">
                            <label class="block text-[11px] font-bold text-slate-500 uppercase tracking-wider mb-1.5">Karigar Name</label>
                            <input type="text" name="name" class="w-full border border-slate-300 p-2 text-sm font-bold text-slate-700 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500" required>
                        </div>
                        <div class="w-1/3">
                            <label class="block text-[11px] font-bold text-slate-500 uppercase tracking-wider mb-1.5">Date of Birth</label>
                            <input type="date" name="dob" class="w-full border border-slate-300 p-2 text-sm font-bold text-slate-700 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4">
                        <div class="flex-1">
                            ...
                            <input type="text" name="aadhar_no" class="w-full border border-slate-300 p-2 text-sm font-bold text-slate-700 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
                        </div>
                        <div class="flex-1">
                            <label class="block text-[11px] font-bold text-slate-500 uppercase tracking-wider mb-1.5">Mobile No.</label>
                            <input type="text" name="mobile_no" class="w-full border border-slate-300 p-2 text-sm font-bold text-slate-700 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4">
                        <div class="flex-1">
                            ...
                            <input type="text" name="bank_name" class="w-full border border-slate-300 p-2 text-sm font-bold text-slate-700 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
                        </div>
                        <div class="flex-1">
                            <label class="block text-[11px] font-bold text-slate-500 uppercase tracking-wider mb-1.5">Bank Account Number</label>
                            <input type="text" name="bank_account_no" class="w-full border border-slate-300 p-2 text-sm font-bold text-slate-700 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
                        </div>
                    </div>
                        ...
                        <div class="flex-1">
                            <select name="machine_1_id" class="w-full border border-slate-300 p-2 text-sm font-bold text-slate-700 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 bg-white">
                                ...
                                @foreach($machines as $machine)
                                    <option value="{{ $machine->id }}">{{ $machine->machine_no }} - {{ $machine->place }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="w-32">
                            <input type="number" step="0.01" name="machine_1_top_rs" placeholder="Top RS." class="w-full border border-slate-300 p-2 text-sm font-bold text-slate-700 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 text-center">
                        </div>
                        <div class="w-32">
                            <input type="number" step="0.01" name="machine_1_dup_rs" placeholder="Dup. Rs" class="w-full border border-slate-300 p-2 text-sm font-bold text-slate-700 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 text-center">
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4 items-center bg-slate-50 p-3 border border-slate-200">
                        ...
                        <div class="w-32">
                            <input type="number" step="0.01" name="machine_2_top_rs" placeholder="Top RS." class="w-full border border-slate-300 p-2 text-sm font-bold text-slate-700 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 text-center">
                        </div>
                        <div class="w-32">
                            <input type="number" step="0.01" name="machine_2_dup_rs" placeholder="Dup. Rs" class="w-full border border-slate-300 p-2 text-sm font-bold text-slate-700 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 text-center">
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4 items-center bg-slate-50 p-3 border border-slate-200">
                        ...
                        <div class="w-32">
                            <input type="number" step="0.01" name="machine_3_top_rs" placeholder="Top RS." class="w-full border border-slate-300 p-2 text-sm font-bold text-slate-700 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 text-center">
                        </div>
                        <div class="w-32">
                            <input type="number" step="0.01" name="machine_3_dup_rs" placeholder="Dup. Rs" class="w-full border border-slate-300 p-2 text-sm font-bold text-slate-700 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 text-center">
                        </div>
                    </div>
