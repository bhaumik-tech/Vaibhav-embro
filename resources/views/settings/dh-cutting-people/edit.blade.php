@extends('layouts.app')
@section('title', 'Edit Dh.cutting person')
...
<div class="h-full flex flex-col max-w-4xl mx-auto w-full">
    ...
    <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 mb-6 shrink-0">
        ...
        <div class="bg-slate-100 border border-slate-300 py-2.5 px-6 font-bold text-slate-700 text-sm uppercase tracking-wider shadow-sm flex-1">
            Edit Dh.cutting person (setting)
        </div>
    </div>
    ...
    <div class="bg-white border border-slate-300 shadow-sm p-8 flex-1">
        <form action="{{ route('dh-cutting-people.update', $dhCuttingPerson) }}" method="POST" class="flex flex-col gap-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                <div class="md:col-span-9">
                    ...
                    <input type="text" name="person_name" required value="{{ old('person_name', $dhCuttingPerson->person_name) }}" placeholder="Enter person name"
                ...
                <div class="md:col-span-3">
                    ...
                    <input type="text" name="lj_type" value="{{ old('lj_type', $dhCuttingPerson->lj_type) }}" placeholder="L/J type"
                        class="w-full border border-slate-300 p-3 text-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 bg-slate-50 font-bold text-slate-800">
                </div>
                ...
                <div class="md:col-span-6">
                    ...
                    <input type="text" name="person_code" value="{{ old('person_code', $dhCuttingPerson->person_code) }}" placeholder="Enter person code"
                        class="w-full border border-slate-300 p-3 text-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 bg-slate-50 font-bold text-slate-800">
                </div>
                ...
                <div class="md:col-span-6">
                    ...
                    <input type="text" name="mobile_no" value="{{ old('mobile_no', $dhCuttingPerson->mobile_no) }}" placeholder="Enter primary mobile no"
                        class="w-full border border-slate-300 p-3 text-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 bg-slate-50 font-bold text-slate-800">
                </div>
                ...
                <div class="md:col-span-6">
                    ...
                    <input type="text" name="aadhar_card_no" value="{{ old('aadhar_card_no', $dhCuttingPerson->aadhar_card_no) }}" placeholder="Aadhar card no."
                        class="w-full border border-slate-300 p-3 text-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 bg-slate-50 font-bold text-slate-800">
                </div>
                ...
                <div class="md:col-span-6">
                    ...
                    <input type="date" name="dob" value="{{ old('dob', $dhCuttingPerson->dob) }}"
                ...
                <div class="md:col-span-6">
                    ...
                    <input type="text" name="second_mobile_no" value="{{ old('second_mobile_no', $dhCuttingPerson->second_mobile_no) }}" placeholder="Enter secondary mobile no"
                        class="w-full border border-slate-300 p-3 text-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 bg-slate-50 font-bold text-slate-800">
                </div>
                ...
                <div class="md:col-span-12">
                    ...
                    <textarea name="full_address" rows="3" placeholder="Enter full address"
                        class="w-full border border-slate-300 p-3 text-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 bg-slate-50 font-bold text-slate-800">{{ old('full_address', $dhCuttingPerson->full_address) }}</textarea>
                </div>
            </div>
            ...
            <div class="mt-6 border-t border-slate-200 pt-6 flex flex-wrap items-end justify-between gap-6">
                ...
                <div class="flex-1 min-w-[250px]">
                    ...
                    <input type="text" name="remark_note" value="{{ old('remark_note', $dhCuttingPerson->remark_note) }}" placeholder="Enter any remarks"
                        class="w-full border border-slate-300 p-3 text-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 bg-slate-50 font-bold text-slate-800">
                </div>
