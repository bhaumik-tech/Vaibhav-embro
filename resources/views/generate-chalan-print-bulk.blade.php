        ...
        <div class="flex-1 bg-white border-[3px] border-primary p-[2px] print:border-[2px] print:shadow-none shadow-xl flex flex-col ml-6 print:ml-10" style="min-height: 195mm; max-width: 50%;">
            ...
            <div class="border-[1.5px] border-primary flex-1 flex flex-col relative" style="padding-left: 2px;">
                ...
                <div class="flex flex-col border-b-[1.5px] border-primary pb-1 relative">
                    ...
                    <!-- Deity Text -->
                    <div class="text-center text-primary font-bold text-[11px] mt-1 mb-0.5">
                        <span class="mr-6">Shree Ganeshay Namah</span>
                        <span>Jay Mataji</span>
                    </div>

                    <!-- Main Company Info -->
                    <div class="flex items-center pb-2 relative mb-2 mt-1" style="min-height: 60px;">
                        <!-- Logo -->
                        <div class="absolute left-2 top-0 flex items-center justify-center" style="height: 100%;">
                            <img src="{{ asset('print-logo.png') }}" alt="Logo" class="object-contain" style="width: 60px; height: 60px;">
                        </div>
