        ...
        <div class="border-[2px] border-slate-400 bg-white flex flex-col print:shadow-none print:p-0">
            <div class="flex flex-col relative h-full">
                    ...
                    <table class="w-full text-left border-collapse" style="table-layout: fixed;">
                        ...
                        <thead>
                            <tr class="border-b-[2px] border-slate-400 h-[28px]">
                                <th class="border-r-[2px] border-slate-400 p-1 text-center text-[12.5px] font-bold"><span class="underline">CH.NO/NO</span></th>
                                <th class="border-r-[2px] border-slate-400 p-1 text-center text-[12.5px] font-bold"><span class="underline">Party Ch.No</span></th>
                ...
                <div class="grid border-b-[2px] border-slate-400 bg-white font-bold text-[13px] h-[32px]" style="grid-template-columns: 9% 9% 12% 35% 12% 9% 14%;">
                    ...
                    <div class="px-2 flex items-center justify-end pr-3 text-[13.5px] text-slate-800">
                        Total Pieces =
                    </div>
                ...
                <div class="flex bg-white font-bold text-[13px] min-h-[190px]">
                    ...
                    <!-- Left Area (65%) -->
                    <div class="w-[65%] flex flex-col border-r-[2px] border-slate-400 relative bg-white">
                        <!-- Full Area Background Logo Watermark -->
                        <div class="absolute inset-0 z-0 flex items-center justify-center pointer-events-none opacity-20 print:opacity-20" style="-webkit-print-color-adjust: exact; print-color-adjust: exact;">
                            <img src="{{ asset('print-logo.png') }}" class="w-[280px] max-w-[80%] max-h-[80%] object-contain" style="opacity: 0.3;">
                        </div>

                        <div class="flex border-b-[2px] border-slate-400 h-[38px] relative z-10 bg-white/70 print:bg-transparent">
                            <div class="w-[54%] border-r-[2px] border-slate-400 px-2 flex items-center tracking-wide text-[13px] font-bold">
                                HSN Code : 988821
                            </div>
                            <div class="w-[46%] px-2 flex flex-col justify-center text-[10.5px] leading-tight text-left text-black font-bold">
                                <div>State : Gujarat</div>
                                <div>Code : 24</div>
                            </div>
                        </div>
                        <div class="flex border-b-[2px] border-slate-400 min-h-[40px] relative z-10 bg-white/70 print:bg-transparent">
                            <div class="w-[54%] border-r-[2px] border-slate-400 px-2 flex items-center justify-center text-[13px] font-bold">
                                Rs In Words :
                            </div>
                        ...
                        <div class="flex flex-col p-2 pt-3 flex-1 relative z-10 bg-white/70 print:bg-transparent justify-between">
                            <div>
                                <div class="underline text-[12px] mb-2 text-black font-bold">On Any Less & Conditions</div>
                                <div class="text-[10px] leading-[1.6] font-bold text-black">
