    ...
    <div class="w-full overflow-x-auto pb-4 print:pb-0 print:overflow-hidden">
        ...
        <div class="border-[2px] border-black bg-white flex flex-col print:shadow-none print:p-0">
            <div class="flex flex-col relative h-full">
                ...
                <div class="flex border-b-[2px] border-black">
                    ...
                    <div class="w-[35%] flex flex-col">
                        <div class="flex-1 flex border-b-[2px] border-black items-stretch">
                            <div class="w-[50%] border-r-[2px] border-black px-3 flex items-center justify-end text-right font-bold text-[13px] leading-none whitespace-nowrap">Invoice No :</div>
                            <div class="w-[50%] flex items-center justify-center text-center font-bold text-[16px] leading-none tabular-nums whitespace-nowrap">{{ $generateBill->bill_no }}</div>
                        </div>
                        <div class="flex-1 flex items-stretch">
                            <div class="w-[50%] border-r-[2px] border-black px-3 flex items-center justify-end text-right font-bold text-[13px] leading-none whitespace-nowrap">Date :</div>
                            <div class="w-[50%] flex items-center justify-center text-center font-bold text-[16px] leading-none tabular-nums whitespace-nowrap">{{ \Carbon\Carbon::parse($generateBill->date)->format('d/m/Y') }}</div>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="w-full text-left border-collapse" style="table-layout: fixed;">
                        ...
                        <thead>
                            <tr class="border-b-[2px] border-black h-[28px]">
                                ...
                                <th class="border-r-[2px] border-black p-1 pr-2 text-right text-[12.5px] font-bold"><span class="underline">Pieces</span></th>
                                <th class="border-r-[2px] border-black p-1 pr-2 text-right text-[12.5px] font-bold"><span class="underline">Rate</span></th>
                        ...
                        <tbody>
                            ...
                            @foreach($generateBill->items as $index => $item)
                                ...
                                <tr class="text-[13.5px] font-bold text-black border-b-[2px] border-black h-[24px]">
                                    <td class="border-r-[2px] border-black px-1 py-0.5 text-center">{{ $item->sr_no ?? ($index + 1) }}</td>
                                    ...
                                    <td class="border-r-[2px] border-black px-2 py-0.5 text-right tabular-nums whitespace-nowrap">{{ number_format($item->pcs, 0) }}</td>
                                    <td class="border-r-[2px] border-black px-2 py-0.5 text-right tabular-nums whitespace-nowrap">{{ number_format($item->rate, 0) }}</td>
                ...
                <div class="grid border-b-[2px] border-black bg-white font-bold text-[13px] h-[32px]" style="grid-template-columns: 9% 9% 12% 35% 12% 9% 14%;">
                    <div class="col-span-3 border-r-[2px] border-black px-2 flex items-center tracking-wide text-[14px]">
                        GSTIN : {{ $generateBill->firm->gst_number }}
                    </div>
                    <div class="px-2 flex items-center justify-end pr-3 text-[13.5px]">
                        Total Pieces =
                    </div>
                    <div class="border-r-[2px] border-black px-2 flex items-center justify-end bg-slate-200 text-right text-[16px] font-extrabold tabular-nums whitespace-nowrap">
