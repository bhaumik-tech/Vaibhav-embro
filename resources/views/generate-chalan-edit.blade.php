            ...
            <div class="flex-1 bg-white border border-slate-200 p-4 shadow-sm relative">
                <div class="flex flex-col gap-2 w-full pt-10 sm:pt-0 sm:pr-24">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <input type="text" id="party-address" value="{{ $generateChalan->party->address ?? '' }}" placeholder="Add" readonly class="flex-1 font-medium text-slate-600 text-sm bg-transparent border-none p-0 focus:ring-0 cursor-not-allowed">
                    </div>
                    <div class="flex items-center gap-2">
